...
const api: RendererApi = {
  ...
  resumeSession: (sessionId, selectedProject) =>
    ipcRenderer.invoke("session:resume", sessionId, selectedProject),
  ...
  terminalChips: (paneKey, path) => ipcRenderer.invoke("terminal:chips", paneKey, path),
