...
describe("workspace markup", () => {
  ...
  it.each([
    ...
    "workspace-devtools-slot",
    "workspace-devtools-close",
    "workspace-devtools-dock-undocked",
    "workspace-devtools-dock-left",
    "workspace-devtools-dock-bottom",
    "workspace-devtools-dock-right",
